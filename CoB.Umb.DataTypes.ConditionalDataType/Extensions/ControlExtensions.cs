...
namespace Cob.Umb.DataTypes.ConditionalDataType.Extensions
{
    public static class ControlExtensions
    {
        ...
        public static Control FindAncestor(this Control control, string id)
        {
            return control.FindAncestor(c => c.ID == id);
        }
